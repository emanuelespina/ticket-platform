...
public class OperatorController {
    ...
    public String postMethodName(@PathVariable Integer id, @RequestParam boolean setAnvaible) {
        ...
        for (Ticket ticket : tickets) {
            ...
            if (ticket.getStatus().equals(TicketStatus.valueOf("IN_CORSO"))) {
        ...
        if (inCorso) {
            ...
            user.setNotAvailable(setAnvaible);

        }
        
        return "redirect:/operators/changer/" + user.getId();
    }
